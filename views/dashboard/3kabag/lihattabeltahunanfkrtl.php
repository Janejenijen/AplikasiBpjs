...
<!DOCTYPE html>
    ...
    <body>
        ...
        <div class="container my-5">
            <h2>Laporan Tahunan FKRTL</h2>
        </div>

            <input type="hidden" name="fkrtl" value="<?php echo $data;?>">
        ...
        <table class="table">
            ...
            if(isset($_POST['submit'])){
                ...
                $sqlsearch = "SELECT * FROM tahunan WHERE tahunan_tahun LIKE '%$search%' and fkrtl_id='$data'";
