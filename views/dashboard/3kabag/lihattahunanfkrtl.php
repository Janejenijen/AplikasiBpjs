            ...
            if($resultsearch){
              if(mysqli_num_rows($resultsearch)>0){
                ...
                <tr>
                   ...
                   <td>
                      <a class='btn btn-primary btn-sm' href='lihattabeltahunanfkrtl.php?data=$rowsearch[fkrtl_id]'>Lihat</a>
                   </td>
                 </tr>
                 </tbody>
                ";
    ...
    <tbody>
      ...
      while($row = $result->fetch_assoc()){
       ...
       <tr>
         ...
         <td>
            <a class='btn btn-primary btn-sm' href='lihattabeltahunanfkrtl.php?data=$row[fkrtl_id]''>Pilih</a>
         </td>
       </tr>
      ";
    }
