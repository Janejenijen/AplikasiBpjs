<?php
    $fkrtl = filter_input(INPUT_POST,"fkrtl", FILTER_SANITIZE_SPECIAL_CHARS);
    ...
    $sql = "INSERT INTO tahunan (fkrtl_id, tahunan_tahun, tahunan_bulan, tahunan_iurbiaya, tahunan_kessan, tahunan_antrionline, tahunan_kontaktdklangsung, tahunan_paktaintegritas, tahunan_prb, tahunan_kepatuhan)
            VALUES ('$fkrtl', '$tahun', '$januari', '$januariiurbiaya', '$januarikessan', '$januariantri', '$januarikontak', '$januaripakta', '$januariprb', '$januarikepatuhan' )";

            mysqli_query($conn, $sql);
    
    $sql2 = "INSERT INTO tahunan (fkrtl_id, tahunan_tahun, tahunan_bulan, tahunan_iurbiaya, tahunan_kessan, tahunan_antrionline, tahunan_kontaktdklangsung, tahunan_paktaintegritas, tahunan_prb, tahunan_kepatuhan)
            VALUES ('$fkrtl', '$tahun', '$februari', '$februariiurbiaya', '$februarikessan', '$februariantri', '$februarikontak', '$februaripakta', '$februariprb', '$februarikepatuhan' )";

            mysqli_query($conn, $sql2);

    $sqlmaret = "INSERT INTO tahunan (fkrtl_id, tahunan_tahun, tahunan_bulan, tahunan_iurbiaya, tahunan_kessan, tahunan_antrionline, tahunan_kontaktdklangsung, tahunan_paktaintegritas, tahunan_prb, tahunan_kepatuhan)
            VALUES ('$fkrtl', '$tahun', '$maret', '$maretiurbiaya', '$maretkessan', '$maretantri', '$maretkontak', '$maretpakta', '$maretprb', '$maretkepatuhan' )";

            mysqli_query($conn, $sqlmaret);

    $sqlapril = "INSERT INTO tahunan (fkrtl_id, tahunan_tahun, tahunan_bulan, tahunan_iurbiaya, tahunan_kessan, tahunan_antrionline, tahunan_kontaktdklangsung, tahunan_paktaintegritas, tahunan_prb, tahunan_kepatuhan)
            VALUES ('$fkrtl', '$tahun', '$april', '$apriliurbiaya', '$aprilkessan', '$aprilantri', '$aprilkontak', '$aprilpakta', '$aprilprb', '$aprilkepatuhan' )";

            mysqli_query($conn, $sqlapril);

    $sqlmei = "INSERT INTO tahunan (fkrtl_id, tahunan_tahun, tahunan_bulan, tahunan_iurbiaya, tahunan_kessan, tahunan_antrionline, tahunan_kontaktdklangsung, tahunan_paktaintegritas, tahunan_prb, tahunan_kepatuhan)
            VALUES ('$fkrtl', '$tahun', '$mei', '$meiiurbiaya', '$meikessan', '$meiantri', '$meikontak', '$meipakta', '$meiprb', '$meikepatuhan' )";

            mysqli_query($conn, $sqlmei);

    $sqljuni = "INSERT INTO tahunan (fkrtl_id, tahunan_tahun, tahunan_bulan, tahunan_iurbiaya, tahunan_kessan, tahunan_antrionline, tahunan_kontaktdklangsung, tahunan_paktaintegritas, tahunan_prb, tahunan_kepatuhan)
            VALUES ('$fkrtl', '$tahun', '$juni', '$juniiurbiaya', '$junikessan', '$juniantri', '$junikontak', '$junipakta', '$juniprb', '$junikepatuhan' )";

            mysqli_query($conn, $sqljuni);
        
    $sqljuli = "INSERT INTO tahunan (fkrtl_id, tahunan_tahun, tahunan_bulan, tahunan_iurbiaya, tahunan_kessan, tahunan_antrionline, tahunan_kontaktdklangsung, tahunan_paktaintegritas, tahunan_prb, tahunan_kepatuhan)
            VALUES ('$fkrtl', '$tahun', '$juli', '$juliiurbiaya', '$julikessan', '$juliantri', '$julikontak', '$julipakta', '$juliprb', '$julikepatuhan' )";

            mysqli_query($conn, $sqljuli);

    $sqlagustus = "INSERT INTO tahunan (fkrtl_id, tahunan_tahun, tahunan_bulan, tahunan_iurbiaya, tahunan_kessan, tahunan_antrionline, tahunan_kontaktdklangsung, tahunan_paktaintegritas, tahunan_prb, tahunan_kepatuhan)
            VALUES ('$fkrtl', '$tahun', '$agustus', '$agustusiurbiaya', '$agustuskessan', '$agustusantri', '$agustuskontak', '$agustuspakta', '$agustusprb', '$agustuskepatuhan' )";

            mysqli_query($conn, $sqlagustus);

    $sqlseptember = "INSERT INTO tahunan (fkrtl_id, tahunan_tahun, tahunan_bulan, tahunan_iurbiaya, tahunan_kessan, tahunan_antrionline, tahunan_kontaktdklangsung, tahunan_paktaintegritas, tahunan_prb, tahunan_kepatuhan)
            VALUES ('$fkrtl', '$tahun', '$september', '$septemberiurbiaya', '$septemberkessan', '$septemberantri', '$septemberkontak', '$septemberpakta', '$septemberprb', '$septemberkepatuhan' )";

            mysqli_query($conn, $sqlseptember);

    $sqloktober = "INSERT INTO tahunan (fkrtl_id, tahunan_tahun, tahunan_bulan, tahunan_iurbiaya, tahunan_kessan, tahunan_antrionline, tahunan_kontaktdklangsung, tahunan_paktaintegritas, tahunan_prb, tahunan_kepatuhan)
            VALUES ('$fkrtl', '$tahun', '$oktober', '$oktoberiurbiaya', '$oktoberkessan', '$oktoberantri', '$oktoberkontak', '$oktoberpakta', '$oktoberprb', '$oktoberkepatuhan' )";

            mysqli_query($conn, $sqloktober);

    $sqlnovember = "INSERT INTO tahunan (fkrtl_id, tahunan_tahun, tahunan_bulan, tahunan_iurbiaya, tahunan_kessan, tahunan_antrionline, tahunan_kontaktdklangsung, tahunan_paktaintegritas, tahunan_prb, tahunan_kepatuhan)
            VALUES ('$fkrtl', '$tahun', '$november', '$novemberiurbiaya', '$novemberkessan', '$novemberantri', '$novemberkontak', '$novemberpakta', '$novemberprb', '$novemberkepatuhan' )";

            mysqli_query($conn, $sqlnovember);

    $sqldesember = "INSERT INTO tahunan (fkrtl_id, tahunan_tahun, tahunan_bulan, tahunan_iurbiaya, tahunan_kessan, tahunan_antrionline, tahunan_kontaktdklangsung, tahunan_paktaintegritas, tahunan_prb, tahunan_kepatuhan)
            VALUES ('$fkrtl', '$tahun', '$desember', '$desemberiurbiaya', '$desemberkessan', '$desemberantri', '$desemberkontak', '$desemberpakta', '$desemberprb', '$desemberkepatuhan' )";
...
<!DOCTYPE html>
    ...
    <script>
        function kembaliTabel(){
            location.href = "tahunanfkrtl.php"
        }
